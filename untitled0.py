...
# datas['ACCOUNTSEQNO'] = datas['SEEN72'].cat.codes
# temp = datas[datas['ACCOUNTSEQNO']==0]
# datas.at[temp.index, 'ACCOUNTSEQNO'] = None
# temp = datas[datas['ACCOUNTSEQNO']==2]
# datas.at[temp.index, 'ACCOUNTSEQNO'] = None
# temp = datas[datas['ACCOUNTSEQNO']==1]
# datas.at[temp.index, 'ACCOUNTSEQNO'] = 0
# temp = datas[datas['ACCOUNTSEQNO']==3]
# datas.at[temp.index, 'ACCOUNTSEQNO'] = 1
...
H_select = ['CANCER', 'ETOHAB', 'ALZHD', 'ASTHMA', 'CEBVD', 'CKD', 'COPD',
...
datas['CHIEFCOMPLAIN'] = datas['RFV1']+datas['RFV2']+datas['RFV3']+datas['RFV4']+datas['RFV5']
